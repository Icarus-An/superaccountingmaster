...
public class SpendingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnAddRecord, button2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentDb=new DBOpenHelper(this,"qianbao.db",null,1);

        msr = (TextView) findViewById(R.id.tv_income_money);
        mzc = (TextView) findViewById(R.id.tv_outlay_money);

        MainActivity asd=new MainActivity();
        Bundle bundle = getIntent().getExtras();
        Double bu11 = bundle.getDouble("buffer");
        Double bu22 = bundle.getDouble("buffer1");
        MAX=bundle.getInt("MAXX");
       // bu11=asd.buffer;
       // bu22=asd.buffer1;
        msr.setText(String.valueOf(bu11));
        mzc.setText(String.valueOf(bu22));
    ...
    private void initViews() {
        ...
        tv_income=(TextView)findViewById(R.id.tv_income_money);
    ...
    public void OnAddRecordClick(View v){
        ...
        alertBuilder.setTitle(R.string.select);
        alertBuilder.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                //Toast.makeText(SpendingActivity.this, items[i], Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(SpendingActivity.this,Choice.class);
    ...
    public void deleteRecord(View view) {
        studentDb.deleteDataon(MAX.toString());
        Intent intent = new Intent();
        intent.setClass(SpendingActivity.this, MainActivity.class);
